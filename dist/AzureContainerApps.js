...
const ContainerAppHelper_js_1 = require("./ContainerAppHelper.js");
const ContainerRegistryHelper_js_1 = require("./ContainerRegistryHelper.js");
const GitHubActionsToolHelper_js_1 = require("./GitHubActionsToolHelper.js");
const TelemetryHelper_js_1 = require("./TelemetryHelper.js");
...
class AzureContainerApps {
    ...
    static initializeHelpers() {
        ...
        this.util = new Utility_js_1.Utility();
        // Set up toolHelper for managing calls to the GitHub Actions toolkit
        this.toolHelper = new GitHubActionsToolHelper_js_1.GitHubActionsToolHelper();
        ...
        this.telemetryHelper = new TelemetryHelper_js_1.TelemetryHelper(disableTelemetry);
        // Set up ContainerAppHelper for managing calls around the Container App
        this.appHelper = new ContainerAppHelper_js_1.ContainerAppHelper(disableTelemetry);
        // Set up ContainerRegistryHelper for managing calls around the Container Registry
        this.registryHelper = new ContainerRegistryHelper_js_1.ContainerRegistryHelper();
    }
    /**
